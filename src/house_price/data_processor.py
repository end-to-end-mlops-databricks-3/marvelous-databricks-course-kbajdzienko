...
class DataProcessor:
    ...
    def __init__(self, pandas_df: pd.DataFrame, spark: SparkSession, config: ProjectConfig) -> None:
        ...
        Args:
            ...
            config (ProjectConfig): The project configuration containing feature and target information.
    ...
    def save_to_catalog(self, train_set: pd.DataFrame, test_set: pd.DataFrame) -> None:
        ...
        train_set_spark.write.mode("overwrite").saveAsTable(f"{catalog}.{schema}.train_set")
        test_set_spark.write.mode("overwrite").saveAsTable(f"{catalog}.{schema}.test_set")
